...
Usage:
{{- include "helper.workflow.env" (dict "env" .Values.path.to.env "secrets" .Values.path.to.secrets "configs" .Values.path.to.configs "context" $) | nindent 8}}
*/}}
{{- define "helper.workflow.env" -}}
{{- $fullname := (include "helper.names.fullname" .context)}}
